    ...
    public abstract class ColliderHandler
    {
        ...
        public static void AddCollider(MeshRenderer target)
        {
            ...
            if (target.TryGetComponent<MeshFilter>(out MeshFilter meshFilter))
            {
                ...
                ComponentHandler.AddComponentToTarget(target.transform, type);
            }
        }
        ...
        {
            ComponentHandler.RemoveComponentFromTarget(target, typeof(BoxCollider));
            ComponentHandler.RemoveComponentFromTarget(target, typeof(MeshCollider));
        }
